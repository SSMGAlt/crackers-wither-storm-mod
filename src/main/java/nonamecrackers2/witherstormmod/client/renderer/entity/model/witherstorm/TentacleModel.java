...
public class TentacleModel {
   ...
   public static void populateDefinition(PartDefinition root, int[] length, PartPose offset) {
      ...
      PartDefinition segment1 = tentacle.addOrReplaceChild(
         "segment1",
         CubeListBuilder.create().texOffs(36 + (24 - length[0]), 14 + (24 - length[0])).addBox(-6.0F, -6.0F, -length[0], 12.0F, 12.0F, length[0], false),
         PartPose.ZERO
      );
      PartDefinition segment2 = segment1.addOrReplaceChild(
         "segment2",
         CubeListBuilder.create().texOffs(76 + (32 - length[1]), 32 + (32 - length[1])).addBox(-5.0F, -5.0F, -length[1], 10.0F, 10.0F, length[1], false),
         PartPose.offset(0.0F, 0.0F, -length[0])
      );
      PartDefinition segment3 = segment2.addOrReplaceChild(
         "segment3",
         CubeListBuilder.create().texOffs(76 + (32 - length[2]), 33 + (32 - length[2])).addBox(-4.0F, -4.0F, -length[2], 8.0F, 8.0F, length[2], false),
         PartPose.offset(0.0F, 0.0F, -length[1])
      );
      PartDefinition segment4 = segment3.addOrReplaceChild(
         "segment4",
         CubeListBuilder.create().texOffs(77 + (32 - length[3]), 34 + (32 - length[3])).addBox(-3.0F, -3.0F, -length[3], 6.0F, 6.0F, length[3], false),
         PartPose.offset(0.0F, 0.0F, -length[2])
      );
      PartDefinition segment5 = segment4.addOrReplaceChild(
         "segment5",
         CubeListBuilder.create().texOffs(76 + (34 - length[4]), 36 + (34 - length[4])).addBox(-2.0F, -2.0F, -length[4], 4.0F, 4.0F, length[4], false),
         PartPose.offset(0.0F, 0.0F, -length[3])
      );
      segment5.addOrReplaceChild(
         "segment6",
         CubeListBuilder.create().texOffs(77 + (34 - length[5]), 38 + (34 - length[5])).addBox(-1.0F, -1.0F, -length[5], 2.0F, 2.0F, length[5], false),
         PartPose.offset(0.0F, 0.0F, -length[4])
      );
   }
