...
public class LowResIntermediateDevourerBodyModel {
   public static PartDefinition createBodyModel(PartDefinition root, float texScale) {
      ...
      body.addOrReplaceChild(
         "voxel_r19",
         CubeListBuilder.create().texOffs(0, 24).addBox(-13.75F, -12.2293F, -4.0004F, 18.0F, 14.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r24",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.2193F, -14.3536F, -2.9688F, 15.0F, 13.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(4.0F, -4.5F, -7.5F, 0.6274F, -0.2168F, -0.1478F)
      );
      body.addOrReplaceChild(
         "voxel_r25",
         CubeListBuilder.create().texOffs(0, 24).addBox(-10.05F, -12.9753F, -3.0258F, 10.0F, 13.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-12.95F, -15.0F, -16.3F, 0.1122F, 0.492F, 0.1529F)
      );
      body.addOrReplaceChild(
         "voxel_r26",
         CubeListBuilder.create().texOffs(0, 24).addBox(-9.8676F, -12.6159F, -0.7064F, 10.0F, 13.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
