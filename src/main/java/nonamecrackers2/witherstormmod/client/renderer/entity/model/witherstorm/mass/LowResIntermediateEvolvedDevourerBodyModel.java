...
public class LowResIntermediateEvolvedDevourerBodyModel {
   public static PartDefinition createBodyModel(PartDefinition root, float texScale) {
      ...
      body.addOrReplaceChild(
         "voxel_r7",
         CubeListBuilder.create().texOffs(0, 24).addBox(-10.8919F, -3.7192F, -0.1851F, 11.0F, 9.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r20",
         CubeListBuilder.create().texOffs(0, 24).addBox(-13.95F, -12.6481F, -0.0744F, 14.0F, 13.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r33",
         CubeListBuilder.create().texOffs(0, 24).addBox(-10.9682F, 0.2493F, -0.3086F, 11.0F, 10.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-20.05F, -39.65F, 27.4F, -2.7544F, -0.4795F, 0.0227F)
      );
      body.addOrReplaceChild(
         "voxel_r34",
         CubeListBuilder.create().texOffs(0, 24).addBox(-11.0951F, -3.4567F, -0.0649F, 11.0F, 10.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r56",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.1338F, -9.9836F, -7.2605F, 5.0F, 10.0F, 14.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-16.1F, -65.9F, -1.0F, 0.0194F, 0.0496F, 1.4416F)
      );
      body.addOrReplaceChild(
         "voxel_r57",
         CubeListBuilder.create().texOffs(0, 25).addBox(-0.0124F, -13.1351F, -0.0187F, 5.0F, 11.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r64",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.0774F, -9.9357F, -11.9545F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r66",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.0105F, -9.9865F, -0.1337F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r68",
         CubeListBuilder.create().texOffs(0, 24).addBox(0.1058F, -10.2583F, -0.0606F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-46.1F, -36.2F, 6.3F, -8.0E-4F, 0.5002F, 0.1313F)
      );
      body.addOrReplaceChild(
         "voxel_r69",
         CubeListBuilder.create().texOffs(0, 24).addBox(0.0597F, -9.9512F, -11.9989F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-39.2F, -45.7F, -16.4F, -0.6312F, -0.6993F, 0.9799F)
      );
      body.addOrReplaceChild(
         "voxel_r70",
         CubeListBuilder.create().texOffs(0, 24).addBox(0.0063F, -7.4053F, -11.9398F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-40.1F, -38.3F, -16.4F, -0.0012F, -0.9048F, 0.1326F)
      );
      body.addOrReplaceChild(
         "voxel_r71",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.1391F, -10.2672F, -11.9631F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-46.1F, -36.2F, -5.8F, -8.0E-4F, -0.5034F, 0.1321F)
      );
      body.addOrReplaceChild(
         "voxel_r72",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.042F, -10.2636F, -4.7621F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r76",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.0389F, -7.9915F, -12.0609F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-28.85F, -33.0F, -23.1F, -0.0797F, -1.4648F, -0.1817F)
      );
      body.addOrReplaceChild(
         "voxel_r77",
         CubeListBuilder.create().texOffs(0, 24).addBox(0.0088F, -6.3833F, -11.9972F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-38.6F, -32.0F, -16.1F, -0.0143F, -0.9415F, -0.2494F)
      );
      body.addOrReplaceChild(
         "voxel_r78",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.0933F, -10.1271F, -12.0451F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(-43.6F, -26.7F, -5.8F, -0.0099F, -0.5488F, -0.2558F)
      );
      body.addOrReplaceChild(
         "voxel_r79",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.0049F, -10.0867F, -4.8442F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r83",
         CubeListBuilder.create().texOffs(0, 24).addBox(-0.1072F, -10.2392F, -12.001F, 5.0F, 10.0F, 12.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r87",
         CubeListBuilder.create().texOffs(2, 26).addBox(0.0734F, -7.6234F, -10.0158F, 5.0F, 12.0F, 10.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r116",
         CubeListBuilder.create().texOffs(6, 30).addBox(-4.9944F, -12.0621F, -4.7139F, 5.0F, 12.0F, 6.0F, CubeDeformation.NONE, texScale, texScale),
         PartPose.offsetAndRotation(38.2F, -42.7F, -12.6F, -0.4182F, 0.8223F, -0.4803F)
      );
      body.addOrReplaceChild(
         "voxel_r117",
         CubeListBuilder.create().texOffs(4, 28).addBox(-4.9136F, -11.0262F, -7.9757F, 5.0F, 12.0F, 8.0F, CubeDeformation.NONE, texScale, texScale),
      ...
      body.addOrReplaceChild(
         "voxel_r147",
         CubeListBuilder.create().texOffs(0, 24).addBox(-3.4217F, -10.2414F, -9.7983F, 6.0F, 7.0F, 13.0F, CubeDeformation.NONE, texScale, texScale),
