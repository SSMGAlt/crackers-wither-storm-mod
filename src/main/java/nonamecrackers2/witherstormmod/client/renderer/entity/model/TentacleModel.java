...
public class TentacleModel extends EntityModel<TentacleEntity> {
   ...
   public static LayerDefinition createLayerDefinition() {
      ...
      PartDefinition segment2 = segment.addOrReplaceChild(
         "segment2", CubeListBuilder.create().texOffs(0, 24).addBox(-5.0F, -16.0F, -5.0F, 10.0F, 16.0F, 10.0F, false), PartPose.offset(0.0F, -12.0F, 0.0F)
      );
      PartDefinition segment3 = segment2.addOrReplaceChild(
         "segment3", CubeListBuilder.create().texOffs(40, 16).addBox(-4.0F, -20.0F, -4.0F, 8.0F, 20.0F, 8.0F, false), PartPose.offset(0.0F, -16.0F, 0.0F)
      );
      PartDefinition segment4 = segment3.addOrReplaceChild(
         "segment4", CubeListBuilder.create().texOffs(34, 44).addBox(-3.0F, -24.0F, -3.0F, 6.0F, 24.0F, 6.0F, false), PartPose.offset(0.0F, -20.0F, 0.0F)
      );
      segment4.addOrReplaceChild(
         "segment5", CubeListBuilder.create().texOffs(0, 50).addBox(-2.0F, -24.0F, -2.0F, 4.0F, 24.0F, 4.0F, false), PartPose.offset(0.0F, -24.0F, 0.0F)
      );
