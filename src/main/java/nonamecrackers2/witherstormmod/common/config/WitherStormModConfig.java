...
public class WitherStormModConfig {
   ...
   public static class CommonConfig extends ConfigHelper {
      ...
      private CommonConfig(Builder builder) {
         ...
         this.injectAiMobBlacklist = this.createListValue(
            String.class,
            () -> {
            ...
            val -> ResourceLocation.isValidResourceLocation(val),
            "injectAiMobBlacklist",
            true,
            "A list of mobs that should not have custom AI injected into them"
         );
