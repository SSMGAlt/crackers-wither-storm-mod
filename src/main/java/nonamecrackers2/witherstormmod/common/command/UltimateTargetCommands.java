            ...
            ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ultimateTarget")
                        ...
                        .then(
                           ((LiteralArgumentBuilder)Commands.literal("get")
                                 .then(
                                    Commands.literal("pos").then(Commands.argument("storm", EntityArgument.entity()).executes(UltimateTargetCommands::getPos))
                                 ))
                              .then(
                     ...
                     ((LiteralArgumentBuilder)Commands.literal("distractions")
                           .then(
                              Commands.literal("makeDistracted")
                                 .then(Commands.argument("witherstorm", EntityArgument.entity()).executes(UltimateTargetCommands::makeUltimateTargetDistracted))
                           ))
                        .then(
               ...
               .then(
                  ((LiteralArgumentBuilder)Commands.literal("chase")
                     ...
                     .then(Commands.literal("stop").then(Commands.argument("witherstorm", EntityArgument.entity()).executes(UltimateTargetCommands::stopChase)))
               )
         );
         ...
         if (target instanceof LivingEntity && !target.equals(storm) && !(target instanceof WitherStormSegmentEntity)) {
            ...
            if (manager != null) {
               if (target.getUUID().equals(manager.getTargetOverride())) {
                  ...
                  source.sendSuccess(
                     () -> Component.translatable("commands.witherstormmod.ultimateTarget.set.success", new Object[]{target.getDisplayName()}), true
                  );
               }
            } else {
   ...
   private static int getPos(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
      ...
      if (EntityArgument.getEntity(context, "storm") instanceof WitherStormEntity storm) {
         ...
         if (pos != null) {
            source.sendSuccess(
               () -> {
                  double x = Math.round(pos.x * 10.0) / 10.0;
                  double y = Math.round(pos.y * 10.0) / 10.0;
                  double z = Math.round(pos.z * 10.0) / 10.0;
                  ...
                  return Component.translatable(
                     ...
                     new Object[]{
                        storm.getDisplayName(), x, y, z, Component.translatable("commands.witherstormmod.ultimateTarget.get.pos.click").withStyle(style)
                     }
                  );
               },
               false
   ...
   private static int getUltimateTarget(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
      ...
      if (EntityArgument.getEntity(context, "storm") instanceof WitherStormEntity storm) {
         ...
         if (target != null) {
               ...
               () -> {
                  ...
                  return Component.translatable(
                     ...
                     new Object[]{
                        ...
                        Component.translatable("commands.witherstormmod.ultimateTarget.get.player.click").withStyle(style)
                     }
                  );
               },
               false
            ...
            source.sendSuccess(
               () -> Component.translatable("commands.witherstormmod.ultimateTarget.get.player.none", new Object[]{storm.getDisplayName()}), false
            );
         }
      } else {
         source.sendFailure(Component.translatable("commands.witherstormmod.entity.arg.invalid"));
         ...
         if (entity instanceof WitherStormEntity storm) {
            ...
            if (manager != null) {
               if (!manager.isTargetStationary()) {
                  manager.accelerate();
                  source.sendSuccess(
                     () -> Component.translatable("commands.witherstormmod.ultimateTarget.beginChase", new Object[]{storm.getDisplayName()}), true
                  );
               } else {
         ...
         if (entity instanceof WitherStormEntity storm) {
            ...
            if (manager != null) {
               if (manager.isTargetStationary()) {
                  ...
                  source.sendSuccess(
                     () -> Component.translatable("commands.witherstormmod.ultimateTarget.stopChase", new Object[]{storm.getDisplayName()}), true
                  );
               } else {
